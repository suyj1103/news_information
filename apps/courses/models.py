...
class Teacher(ModelBase):
    ...
    profile = models.TextField(verbose_name='讲师简称')
...
class CourseCategorv(ModelBase):
...
class Course(ModelBase):
    ...
    category = models.ForeignKey(CourseCategorv,on_delete=models.SET_NULL,null=True,blank=True)
